...
from .models import User, Lead, Referral, Transaction, BankAccount, Payout, DealSubmission, AppSettings
...
def contact(request):
    if request.method == 'POST':
        messages.success(request, 'Message received. We will respond within one business day.')
